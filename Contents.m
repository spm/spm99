...
%
%_______________________________________________________________________
% @(#)Contents.m	2.4 Andrew Holmes 00/01/25
%
% SPM99 - Manifest
%-----------------------------------------------------------------------
% Contents.m                    2.4
...
% spm_bch.m                     2.7
% spm_bch.man                   2.6
% spm_bch_DoCont.m              2.6
% spm_bch_GetCont.m             2.5
% spm_bch_bchmat.m              2.6
% spm_bch_headers.m             2.5
% spm_bch_tsampl.m              2.8
% spm_bigend.m                  2.1
% spm_brainwarp.c               2.9
% spm_brainwarp.dll             2.9
% spm_brainwarp.m               2.2
% spm_brainwarp.mexlx           2.9
% spm_brainwarp.mexsol          2.9
% spm_check_registration.m      2.2
% spm_chi2_plot.m               1.2
% spm_choose.m                  2.8
% spm_clf.m                     2.1
% spm_clusters.c                2.2
...
% spm_conv.m                    1.4
% spm_conv_vol.c                2.4
% spm_conv_vol.dll              2.4
% spm_conv_vol.m                2.1
% spm_conv_vol.mexlx            2.4
% spm_conv_vol.mexsol           2.4
% spm_coreg_ui.m                2.1
% spm_coregister.m              2.9
% spm_create_image.m            2.4
% spm_datatypes.h               2.1
% spm_dbm.m                     2.2
% spm_dctmtx.m                  1.3
% spm_defaults.m                2.14
% spm_defaults_edit.m           2.18
% spm_detrend.m                 2.1
% spm_dummy.m                   2.2
% spm_en.m                      1.1
% spm_extract.m                 2.2
% spm_fMRI_design.m             2.27
% spm_fMRI_design_show.m        2.17
% spm_figure.m                  2.24
% spm_filter.m                  2.4
% spm_fir.m                     2.1
% spm_fmri_spm_ui.m             2.31
% spm_format.man                2.1
% spm_get.m                     2.37
% spm_getSPM.m                  2.35
% spm_get_bf.m                  2.16
...
% spm_sys_deps.h                2.5
% spm_t2z.m                     2.2
% spm_templates.man             2.6
% spm_transverse.m              2.15
% spm_type.m                    2.3
% spm_u.m                       2.1
% spm_uc.m                      2.3
% spm_unlink.c                  1.2
